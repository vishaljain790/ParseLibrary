...
public class Chat extends CustomActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		getActionBar().setIcon(R.drawable.mainlogog);
	...
	private void sendMessage()
	{
		...
		po.put("sender", AfterLogin.user.getUsername());
	...
	private void loadConversationList()
	{
		...
		if (convList.size() == 0)
		{
			...
			al.add(buddy);
			al.add(AfterLogin.user.getUsername());
		...
		else
		{
			...
			q.whereEqualTo("receiver", AfterLogin.user.getUsername());
		}
